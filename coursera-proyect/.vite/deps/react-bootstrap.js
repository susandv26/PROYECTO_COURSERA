...
var NavLink = React49.forwardRef(({
  ...
  return (0, import_jsx_runtime44.jsx)(Component2, {
    ...
    ref,
    disabled,
    className: (0, import_classnames33.default)(className, bsPrefix, disabled && "disabled", meta.isActive && "active")
  });
});
...
var Nav2 = React50.forwardRef((uncontrolledProps, ref) => {
  ...
  return (0, import_jsx_runtime45.jsx)(Nav_default, {
    ...
    ref,
    activeKey,
    className: (0, import_classnames34.default)(className, {
      [bsPrefix]: !isNavbar,
...
var NavbarBrand = React51.forwardRef(({
  bsPrefix,
  className,
  as,
  ...props
...
var NavbarCollapse = React52.forwardRef(({
  children,
  bsPrefix,
  ...props
}, ref) => {
  bsPrefix = useBootstrapPrefix(bsPrefix, "navbar-collapse");
  const context5 = (0, import_react25.useContext)(NavbarContext_default);
  return (0, import_jsx_runtime47.jsx)(Collapse_default, {
...
var NavbarToggle = React53.forwardRef(({
  bsPrefix,
  className,
  children,
  ...
  return (0, import_jsx_runtime48.jsx)(Component2, {
    ...
    onClick: handleClick,
    "aria-label": label,
    className: (0, import_classnames36.default)(className, bsPrefix, !expanded && "collapsed"),
    children: children || (0, import_jsx_runtime48.jsx)("span", {
...
var OffcanvasBody = React54.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var OffcanvasToggling = React55.forwardRef(({
  bsPrefix,
  className,
  children,
  in: inProp = false,
  ...
  return (0, import_jsx_runtime50.jsx)(TransitionWrapper_default, {
    ref,
    addEndListener: transitionEndListener,
    in: inProp,
    mountOnEnter,
    ...
    ...props,
    childRef: children.ref,
    children: (status, innerProps) => React55.cloneElement(children, {
      ...innerProps,
...
var OffcanvasHeader = React56.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
var OffcanvasTitle = React57.forwardRef(({
  className,
  bsPrefix,
...
function DialogTransition(props) {
  return (0, import_jsx_runtime53.jsx)(OffcanvasToggling_default, {
    ...props
  });
}
...
var Offcanvas = React58.forwardRef(({
  bsPrefix,
  className,
  children,
  ...
  const renderBackdrop = (0, import_react29.useCallback)((backdropProps) => (0, import_jsx_runtime53.jsx)("div", {
    ...backdropProps,
  ...
  return (0, import_jsx_runtime55.jsxs)(import_jsx_runtime54.Fragment, {
    children: [!showOffcanvas && (responsive || renderStaticNode) && renderDialog({}), (0, import_jsx_runtime53.jsx)(ModalContext_default.Provider, {
      value: modalContext,
...
var NavbarOffcanvas = React59.forwardRef((props, ref) => {
  const context5 = (0, import_react30.useContext)(NavbarContext_default);
  return (0, import_jsx_runtime56.jsx)(Offcanvas_default, {
    ref,
...
var NavbarText = React60.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "span",
  ...props
...
var Navbar = React61.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime58.jsx)(NavbarContext_default.Provider, {
    value: navbarContext,
...
function useTabPanel(_ref) {
  ...
  const context5 = (0, import_react38.useContext)(TabContext_default);
...
var ToastFade = React86.forwardRef((props, ref) => (0, import_jsx_runtime89.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastHeader = React88.forwardRef(({
  ...
  const context5 = (0, import_react40.useContext)(ToastContext_default);
  const handleClick = useEventCallback((e) => {
